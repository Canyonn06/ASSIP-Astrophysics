...
def smallbox(img):
  ...
  # box in 2 formats
    ...
    print("Please select the lower left and upper right corners of your small box.")
...
def man_getpts():
    ...
    print("Select all of your points. Left CLick adds point, Right removes the most recently added. When done, click the 'Enter' key or Center Mouse button.")
...
#color options r,g,b,c,m,y,k in quotes
    ...
    plt.plot(vel, label = labelp, marker = 'o', markersize = 10, color = line_color, linewidth = 1)
